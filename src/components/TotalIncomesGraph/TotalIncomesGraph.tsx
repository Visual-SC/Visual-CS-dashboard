...
import { useTotalIncomes } from './useTotalIncomes';
import type { ChartDataItem, Period } from './useTotalIncomes';
...
function TotalIncomesGraph() {
  ...
  return (
    <section className="bg-light-blue rounded-xl p-4 relative">
      <TotalncomesOptions isOpen={showOptions} onSelectPeriod={(p) => { setPeriod(p); setShowOptions(false); }} />
