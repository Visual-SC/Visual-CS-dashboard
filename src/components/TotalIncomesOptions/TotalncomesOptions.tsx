import type { Period } from '../TotalIncomesGraph/useTotalIncomes';
...
const TotalncomesOptions:React.FC<TotalIncomesProps> = ({isOpen, onSelectPeriod}) => {
  ...
  return (
    <article className="z-10 w-26 h-24 flex flex-col p-1 right-1.5 top-1.5 bg-[#aedbe0]/60 rounded-xl absolute">
