  ...
  return (
    ...
    max-cellphone:w-full max-cellphone:p-2">
      <header className="flex justify-between max-cellphone:justify-center">
        ...
        <Link to={"/eventos"} className="inline-flex w-auto items-center max-cellphone:hidden">
      ...
      <p className="text-p-16 text-dark-green max-cellphone:text-center">Eventos para el presente mes</p>
      <section>
      ...
      <Link to={"/eventos"} className="inline-flex w-auto items-center cellphone:hidden
      max-cellphone:flex max-cellphone:mt-4 max-cellphone:justify-center">
          <p className="text-p-16 font-semibold text-dark-green">Ver eventos</p>
          <img src="./akar-icons_link-out-green.svg" className="w-4 h-6 ml-4" alt="Ver eventos Rodson Coffee" />
      </Link>
    </div>
